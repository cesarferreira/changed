...
### Changed
- Fix false clean state during rebase by parsing unmerged status lines.
...
<!-- next-url -->
[Unreleased]: https://github.com/cesarferreira/changed/compare/v0.5.1...HEAD
[0.5.1]: https://github.com/cesarferreira/changed/compare/v0.5.0...v0.5.1
[0.5.0]: https://github.com/cesarferreira/changed/compare/v0.4.0...v0.5.0
